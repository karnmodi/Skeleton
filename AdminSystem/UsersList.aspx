...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnDelete" runat="server" style="z-index: 1; left: 224px; top: 388px; position: absolute" Text="Delete" />
        <asp:Button ID="btnAdd" runat="server" OnClick="btnAdd_Click" style="z-index: 1; left: 68px; top: 391px; position: absolute;" Text="Add" />
        <asp:Button ID="btnEdit" runat="server" style="z-index: 1; left: 144px; top: 390px; position: absolute;" Text="Edit" />
    </form>
</body>
</html>
