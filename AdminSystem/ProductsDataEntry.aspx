...
<body style="height: 668px">
    ...
    <form id="form1" runat="server">
        ...
        <asp:Label ID="lblProductID" runat="server" style="z-index: 1; left: 10px; top: 37px; position: absolute" Text="Prodcut ID"></asp:Label>
        <p>
        ...
        <p>
            &nbsp;</p>
        <asp:Label ID="lblDescription" runat="server" style="z-index: 1; left: 10px; position: absolute; right: 1062px" Text="Description" width="86px"></asp:Label>
        ...
        <asp:TextBox ID="txtAvaibility" runat="server" style="z-index: 1; left: 106px; top: 318px; position: absolute"></asp:TextBox>
